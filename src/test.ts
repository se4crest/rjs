// import { Option, conExp, exp, ifExp, match, none, some } from ".";
// import { Options, variant } from "./common";
...
// function testEnum(variant: Options) { // if you want to force typescript don't check generic in Option<T>
...
// // }, "fooooooo" === "baaaaaaarr" || 87 < 800 && Array.isArray(Function()) // imagine too long condition and you don't want to reuse it
