...
//     case "object": return typeof rhsValue === "object" ? Array.isArray(lhsValue) && Array.isArray(rhsValue) ?
//       exp(() => {
...
//       }) : exp(() => {
//           console.log(typeof rhsValue, " ", Array.isArray(lhsValue) && Array.isArray(rhsValue))
...
//           if (lhsValue instanceof Map && rhsValue instanceof Map || lhsValue instanceof Set && rhsValue instanceof Set ) {
